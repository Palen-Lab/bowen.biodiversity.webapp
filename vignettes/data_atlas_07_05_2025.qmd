...
writeRaster(bird_richness, here("inst/extdata/2_species/birds_richness.tif"))
...
mammalsmall_richness <- sdm_to_species_richness(SDM_stack = SDM_stack,
                                          presence_threshold = presence_threshold)
writeRaster(mammalsmall_richness, here("inst/extdata/2_species/sm_mammals_richness.tif"))
...
herptile_richness <- sdm_to_species_richness(SDM_stack = SDM_stack,
                                          presence_threshold = presence_threshold)
writeRaster(herptile_richness, here("inst/extdata/2_species/herptiles_richness.tif"))
...
thr_richness <- sdm_to_species_richness(SDM_stack = SDM_stack,
                                        presence_threshold = presence_threshold)
writeRaster(thr_richness, here("inst/extdata/2_species/threatened_richness.tif"))
...
total_richness <- sdm_to_species_richness(SDM_stack = SDM_stack,
                                          presence_threshold = presence_threshold)
writeRaster(total_richness, here("inst/extdata/2_species/total_richness.tif"))
...
writeRaster(SDM_sum, here("inst/extdata/2_species/sum_sdms.tif"))
...
bowen_hfp <- here("inst/extdata/bowen_human_footprint_recl.tif") %>%
  rast() %>%
  as.factor()
...
foreach(quant = quants) %do% {
  ...
  # 5.5 Biodiversity Values overlap with Human Disturbance (continuous)
  bowen_hfp_continuous_bottom <- rankmap_mask * rast(here("inst/extdata/bowen_human_footprint.tif"))
