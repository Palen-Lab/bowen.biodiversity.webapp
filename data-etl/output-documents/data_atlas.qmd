...
combined_biodiversity_plot_base <- template_plot +
  tidyterra::geom_spatraster(data = rankmap) +
...
## Biodiversity Value with Public Lands 
...
parcelmap_extract_sf <- st_as_sf(parcelmap_extract)

ggplot(parcelmap_extract_sf) + geom_sf(aes(fill = rankmap))

parcelmap_biod_vals_plot <- template_plot +
  geom_sf(
...
ggplot2::ggsave(
  here(output_dir, "parcelmap_biod_vals_plot.png"),
  parcelmap_biod_vals_plot,
  device = ragg::agg_png,
  width = 9,
  height = 12,
  units = "in",
