...
ggplot2::ggsave(
  here(output_dir_annotated, "2_1_basic_map.png"),
  basic_plot,
  device = ragg::agg_png,
  width = plot_width,
  height = plot_height,
...
ggplot2::ggsave(
  here(output_dir_unannotated, "2_1_basic_map_no_annotations.png"),
...
# Save plot
ggplot2::ggsave(
  here(output_dir_annotated, "3_1_total_species_richness.png"),
...
ggplot2::ggsave(
  here(output_dir_unannotated, "3_1_total_species_richness_no_annotations.png"),
...
# Save plots
ggplot2::ggsave(
  here(output_dir_annotated, "4_1_bowen_water_map_annotation.png"),
  fw_plot_annotation,
  device = ragg::agg_png,
  width = 9,
  height = 12,
...
ggplot2::ggsave(
  here(output_dir_unannotated, "4_1_bowen_water_map_no_annotation.png"),
...
# Save plots
ggplot2::ggsave(
  here(output_dir_annotated, "4_2_bowen_water_richness_map.png"),
...
ggplot2::ggsave(
  here(output_dir_unannotated, "4_2_bowen_water_richness_map_no_annotation.png"),
...
# Saving plot
ggplot2::ggsave(
  here(output_dir_annotated, "4_3_bowen_habitat_richness_map.png"),
...
ggplot2::ggsave(
  here(output_dir_unannotated, "4_3_bowen_habitat_richness_map_no_annotation.png"),
...
# Save plot
ggplot2::ggsave(
  here(output_dir_annotated, "5_1_combined_biodiversity_values.png"),
...
ggplot2::ggsave(
  here(output_dir_unannotated, "5_1_combined_biodiversity_values_no_annotations.png"),
...
# Save plots 
ggplot2::ggsave(
  here(output_dir_annotated,"5_2_top_30_biodiversity_values.png"),
  top_plot_annotation,
  device = ragg::agg_png,
  width = 9,
  height = 12,
...
ggplot2::ggsave(
  here(output_dir_unannotated,"5_2_top_30_biodiversity_values_no_annotation.png"),
...
# Save plots
ggplot2::ggsave(
  here(output_dir_annotated, "6_1_humandisturbance_continuous.png"),
...
ggplot2::ggsave(
  here(output_dir_unannotated, "6_1_humandisturbance_continuous_no_annotation.png"),
...
# Save plots
ggplot2::ggsave(
  here(output_dir_annotated, "6_2_humandisturbance_top30bv.png"),
...
ggplot2::ggsave(
  here(output_dir_unannotated, "6_2_humandisturbance_top30bv_no_annotation.png"),
...
# Save plots
ggplot2::ggsave(
  here(output_dir_annotated, "6_3_fire_vulnerability_index.png"),
...
ggplot2::ggsave(
  here(output_dir_unannotated, "6_3_fire_vulnerability_index_no_annotation.png"),
...
# Save plots
ggplot2::ggsave(
  here(output_dir_annotated, "6_4_wvi_top30.png"),
  fire_biod_val_plot_annotation,
  device = ragg::agg_png,
  width = 9, height = 12, units = "in", res = 300
)
ggplot2::ggsave(
  here(output_dir_unannotated, "6_4_wvi_top30_no_annotation.png"),
...
# Save plots
ggplot2::ggsave(
  here(output_dir_annotated, "6_5_wui.png"),
  wui_plot_annotation,
  device = ragg::agg_png,
  width = 9,
  height = 12,
...
ggplot2::ggsave(
  here(output_dir_unannotated, "6_5_wui_no_annotation.png"),
...
# Save plots
ggplot2::ggsave(
  here(output_dir_annotated, "7_1_parcelmap_biod_vals_plot.png"),
...
ggplot2::ggsave(
  here(output_dir_unannotated, "7_1_parcelmap_biod_vals_plot_no_annotation.png"),
...
# Save plots
ggplot2::ggsave(
  here(output_dir_annotated, "7_2_parcelmap_subdiv.png"),
...
ggplot2::ggsave(
  here(output_dir_unannotated, "7_2_parcelmap_subdiv_no_annotation.png"),
...
# Save plots
ggplot2::ggsave(
  here(output_dir_annotated, "7_3_biod_vals_protected_areas.png"),
...
ggplot2::ggsave(
  here(output_dir_unannotated, "7_3_biod_vals_protected_areas_no_annotation.png"),
...
privatelands_overlap_plot_no_annotation <- privatelands_overlap_plot_base +
  template_plot_remove()
ggplot2::ggsave(
  here(output_dir_annotated, "7_4_biodvals_private_land.png"),
...
ggplot2::ggsave(
  here(output_dir_unannotated, "7_4_biodvals_private_land_no_annotation.png"),
...
authority_plot_no_annotations <- authority_plot_base +
  template_plot_remove()
ggplot2::ggsave(
  here(output_dir_annotated, "7_5_authority_plot.png"),
...
ggplot2::ggsave(
  here(output_dir_unannotated, "7_5_authority_plot_no_annotations.png"),
...
authority_plot_no_annotations <- authority_plot_base +
  template_plot_remove()
ggplot2::ggsave(
  here(output_dir_annotated, "7_7_authority_top30bv.png"),
  authority_plot_annotations,
  device = ragg::agg_png,
  width = 9,
  height = 12,
...
ggplot2::ggsave(
  here(output_dir_unannotated, "7_7_authority_top30bv_no_annotations.png"),
  authority_plot_no_annotations,
  device = ragg::agg_png,
  width = 9,
  height = 12,
...
# Save plots
ggplot2::ggsave(
  here(output_dir_annotated, "7_6_candidate_protectedareas.png"),
...
ggplot2::ggsave(
  here(output_dir_unannotated, "7_6_candidate_protectedareas_no_annotations.png"),
...
ggplot2::ggsave(
  here(output_dir_unannotated, "8_1_inaturalist_no_annotations.png"),
