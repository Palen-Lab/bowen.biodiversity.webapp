...
09/22/2025: We received feedback that pointed us towards using the full
extent of the Wildfire Vulnerability Index, rather than masking out the
private lands.
...
fire_gg <- function() {
  list(
    ...
    # scale_fill_viridis_d(option = "inferno", na.value = NA, name = "WUI_PSTA"),
    ggnewscale::new_scale_fill(),
    ggnewscale::new_scale_colour()
  )
}
...
ggplot2::ggsave(
  here(output_dir, "/", paste0(Sys.Date(), "_wui.png")),
  fire_ggplot,
  device = ragg::agg_png,
  width = 9, height = 12, units = "in", res = 300
)
