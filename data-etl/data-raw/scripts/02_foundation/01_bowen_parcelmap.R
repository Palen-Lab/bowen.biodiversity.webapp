...
bc_parcelmap_path <-  here("data-raw/datasets/bc_parcelmap")
if(!dir.exists(bc_parcelmap_path)) {
  ...
  dir.create(here("data-raw/datasets/parcelmap"))
  st_write(bowen_parcelmap, here("data-raw/datasets/parcelmap/bowen_parcelmap.gpkg"))
}

bowen_parcelmap <- st_read(here("data-raw/datasets/parcelmap/bowen_parcelmap.gpkg")) %>%
