...
rankmap <- here("inst/extdata/output_zonation/2025-05-02" , "rankmap.tif") %>% rast() %>% project(project_crs)
...
foreach(quant = quants) %do% {
  ...
  bowen_hfp_continuous_top <- rankmap_mask * rast(here("inst/extdata/bowen_human_footprint.tif"))
  ...
  fw_plot <- bowen_map(empty_rast,
    ...
    scale_fill_viridis_c(
      name = paste0("Freshwater / Top ", top_pct, "% Overlap"),
      na.value = "transparent"
    ) +
    geom_sf(data = bowen_ocean_sf,
            linewidth = bowen_ocean_linewidth,
