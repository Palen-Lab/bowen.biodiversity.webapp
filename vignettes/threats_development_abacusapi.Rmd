...
cache_path <- here(Sys.getenv("ABACUS_CACHE_PATH")) # Path to download files, defined in .Renviron
...
spatial_path <- here("data-raw/bc_assessment/abacusBCA/bca_folios_spatial_file_20250110/bca_folios_20250110.gpkg.gpkg")
