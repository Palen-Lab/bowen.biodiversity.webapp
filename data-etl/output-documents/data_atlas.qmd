...
```{r human_disturbance_continuous, eval=F}
#### Prepare raster for plotting ####
...
15.5% of top 30% of WVI values is in the top 30% of biodiversity values. If these were random, then 30% of top 30% of WVI values would be in the top 30% of biodiversity values.
...
fire_biod_val_plot_base <- template_plot +
  ...
  scale_fill_manual(
    values = c("grey40"),           # Single grey color
    labels = c("No Data"),          # Label it as "No Data"
...
wui_plot_base <- template_plot +
  ...
  scale_fill_manual(values = wui_factor_cols, aesthetics = c("colour", "fill")) +
  ggnewscale::new_scale_fill() +
  ggnewscale::new_scale_colour() +
  template_plot_overlay()
